...
export default function ProductError({
  ...
  React.useEffect(() => {
    console.error("Products Page Error Boundary:", error)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-6 border rounded-lg bg-background/50 m-6">
      ...
      <p className="text-sm text-muted-foreground max-w-md mt-1 mb-6">
        An error occurred while loading the products dashboard. This could be due to a database query error or lost connection.
      </p>
